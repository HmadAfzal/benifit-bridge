    ...
    <div className="flex flex-col min-h-screen font-sans">
      ...
      <section className="relative h-[40vh] md:h-[50vh] min-h-[300px] w-full">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="text-white text-4xl md:text-5xl lg:text-6xl">Mortgage Services</h1>
        </div>
      </section>
      ...
      {/* <section className="py-24 px-4 bg-gradient-to-b from-background to-muted/20">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Discover our full range of Cover & Protection Services </p>
          </div>
