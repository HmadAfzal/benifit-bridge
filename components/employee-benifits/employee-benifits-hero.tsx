        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-[600px] text-pretty">
              At The Mortgage Experts, we&apos;re proud to be working in partnership with Newmans Lettings to provide tailored mortgage advice and financial support to their clients. Whether you&apos;re a first-time buyer, a seasoned landlord expanding your portfolio, or simply exploring your next move, our team of experienced advisers is here to guide you every step of the way.
            </p>
