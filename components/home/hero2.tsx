            ...
            <div className="container relative z-20 px-4 md:px-6">
                <div className="container text-center">
                    <div className="mx-auto flex max-w-screen-lg flex-col gap-6">
                        <h1 className="text-3xl font-extrabold lg:text-6xl px-2 text-primary">Connecting employees to their financial future</h1>
                        <p className="text-balance text-primary lg:text-lg">
                            Boost financial wellbeing with expert mortgage & financial planning advice
                        </p>
                    </div>
